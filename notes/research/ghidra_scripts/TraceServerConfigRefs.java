...
public class TraceServerConfigRefs extends GhidraScript {
	private static final String[] TARGETS = new String[] {
		"SvrList.dta",
		"SvrListM.dta",
		"explorer.txt",
		"121.254.248.153",
		"http://laghaimnew.com/update/",
		"config.ini"
	};
	...
	public void run() throws Exception {
		...
		File outputFile = new File(outputDir, currentProgram.getName() + "_server_refs.txt");
